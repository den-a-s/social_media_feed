...
func (c *authClient) Login(ctx context.Context, in *LoginRequset, opts ...grpc.CallOption) (*LoginResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedAuthServer) Login(context.Context, *LoginRequset) (*LoginResponse, error) {
